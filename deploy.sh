...
HEALTH_CHECK_FILE_DIR=/home/device/device-eureke/status   # 脚本会在这个目录下生成nginx-status文件
APP_HOME=/home/device/device-eureke/device-eureke  # 从package.tgz中解压出来的jar包放到这个目录下
JAR_NAME=device-eureke-0.0.1-SNAPSHOT.jar # jar包的名字
...
start_application() {
    ...
    tar -zxvf /home/device/device-eureke/package.tgz -C ${APP_HOME}
